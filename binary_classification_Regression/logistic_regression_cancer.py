...
Original file is located at
    https://colab.research.google.com/drive/10XoY4DsM_159MbjSgmmIDf45hRv4QEij
"""
...
x_train,x_valid,y_train,y_valid = sklearn.model_selection.train_test_split(x_data,y_data,test_size=0.1,random_state=111,stratify=y_data)
print(x_train.shape)
print(x_valid.shape)
print(y_train.shape)
print(y_valid.shape)

x_train,x_test,y_train,y_test = sklearn.model_selection.train_test_split(x_train,y_train,test_size=0.1,random_state=111,stratify=y_train)
print(x_train.shape)
print(x_valid.shape)
print(x_test.shape)
print(y_train.shape)
