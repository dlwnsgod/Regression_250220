# -*- coding: utf-8 -*-
"""02.18_linearRegession.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1tMx_rJGm_R_cLaJv7LE39fZvG6prMrRp
"""
...
#x, y 데이터의 전처리 수행
# x 데이터를 정규분포로 표준화 수행 , - 데이터들의 편차가 심할경우와 너무 큰수는 모델이 훈련하여 가중치 정착에 에로사항이 있다.
